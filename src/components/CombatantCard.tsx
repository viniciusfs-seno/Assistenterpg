...
import { Heart, Zap, Plus, Minus, X, Shield, Sword } from 'lucide-react';
...
export function CombatantCard({ combatant, isCurrentTurn, onUpdate, onRemove }: CombatantCardProps) {
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h3 className={`text-white ${isDead ? 'line-through' : ''}`}>
                  {combatant.name}
                </h3>
                <Badge 
